...
public class MondrianResource extends org.eigenbase.resgen.ShadowResourceBundle {
    ...
    /**
     * <code>SqlQueryLimitReached</code> is '<code>The number of concurrent SQL statements which can be used simultaneously by this Mondrian server instance has been reached. Set &#39;&#39;mondrian.rolap.maxSqlQueryThreads&#39;&#39; to change the current limit.</code>'
     */
    public final _Def3 SqlQueryLimitReached = new _Def3("SqlQueryLimitReached", "The number of concurrent SQL statements which can be used simultaneously by this Mondrian server instance has been reached. Set ''mondrian.rolap.maxSqlQueryThreads'' to change the current limit.", null);
