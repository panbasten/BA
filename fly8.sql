...
INSERT INTO `bi_portal_action` VALUES (1,'预测产品-月预测-打开页面','cust.service.forecastServices','monthPredict'),(2,'预测产品-延伸期预测-打开页面','cust.service.forecastServices','extendPredict'),(3,'预测评分-月预测-打开页面','cust.service.forecastServices','monthPredictScore'),(4,'预测评分-延伸期预测-打开页面','cust.service.forecastServices','extendPredictScore'),(5,'预测产品-当月预测填报-打开页面','cust.service.forecastServices','predictSetting'),(6,'预测产品-当月延伸期预测填报-打开页面','cust.service.forecastServices','extendSetting'),(7,'预测评分-上月预测评分填报-打开页面','cust.service.forecastServices','scoreSetting'),(8,'方法评估-月预测-打开页面','cust.service.forecastServices','monthPredictEvaluate'),(9,'方法评估-延伸期降水过程预测-打开页面','cust.service.forecastServices','extendPredictPrecipitation'),(10,'分析工具-海温月预测-打开页面','cust.service.forecastServices','sstMonthPredict'),(11,'分析工具-海温季预测-打开页面','cust.service.forecastServices','sstQuarterPredict'),(12,'制作评分数据-月预测-打开页面','cust.service.forecastServices','monthPredictData'),(13,'制作评分数据-延伸期预测-打开页面','cust.service.forecastServices','extendPredictData'),(14,'分析工具-数据更新-打开页面','cust.service.forecastServices','dataUpdate'),(15,'制作评分数据-上报数据-打开页面','cust.service.forecastServices','dataUpload'),(16,'业务定时期-打开页面','cust.service.forecastServices','buzTimed'),(17,'业务规范-打开页面','cust.service.forecastServices','buzNorms'),(18,'相关网站链接-打开页面','cust.service.forecastServices','links'),(19,'预测产品-月预测-按月份更新','cust.service.forecastServices','monthPredictUpdate'),(20,'预测产品-延伸期预测-按旬更新','cust.service.forecastServices','extendPredictUpdate'),(21,'预测产品-当月预测填报-更新','cust.service.forecastServices','predictSettingUpdate'),(22,'分析工具-数据更新-更新文件','cust.service.forecastServices','dataUpdateFiles'),(23,'分析工具-海温月预测-执行','cust.service.forecastServices','sstMonthPredictRun'),(24,'分析工具-海温季预测-执行','cust.service.forecastServices','sstQuarterPredictRun'),(25,'制作评分数据-月预测-执行','cust.service.forecastServices','monthPredictDataRun'),(26,'制作评分数据-延伸期预测-执行','cust.service.forecastServices','extendPredictDataRun'),(27,'预测产品-延伸期预测-更新','cust.service.forecastServices','extendSettingUpdate'),(28,'业务规范-更新','cust.service.forecastServices','buzNormsUpdate'),(29,'预测评分-上月预测评分填报-更新','cust.service.forecastServices','scoreSettingUpdate'),(30,'方法评估-上月预测评估填报-打开页面','cust.service.forecastServices','monthPredictEvaluateSetting'),(31,'方法评估-上月预测评估填报-提交','cust.service.forecastServices','monthPredictEvaluateSettingSubmit'),(32,'方法评估-上月延伸期降水过程预测评估填报-打开页面','cust.service.forecastServices','extendPredictPrecipitationSetting'),(33,'方法评估-上月延伸期降水过程预测评估填报-提交','cust.service.forecastServices','extendPredictPrecipitationSettingSubmit'),(34,'制作评分数据-上报数据-月预测评分数据上传','cust.service.forecastServices','monthPredictDataUpload'),(35,'制作评分数据-上报数据-延伸期预测评分数据上传','cust.service.forecastServices','extendPredictDataUpload'),(36,'方法评估-上月预测评估填报-上传文件更新','cust.service.forecastServices','monthPredictEvaluateSettingUpdate'),(37,'制作评分数据-数据展现-打开页面','cust.service.forecastServices','dataShow'),(38,'预测产品-延伸期预测填报-按旬更新','cust.service.forecastServices','extendSettingUpdateSelect'),(0,'Metro','cust.service.forecastServices','metroPortal'),(39,'记事板编辑-打开页面','cust.service.forecastServices','editNotes'),(40,'记事板编辑-保存','cust.service.forecastServices','editNotesSave'),(41,'记事板编辑-切换记事板','cust.service.forecastServices','editNotesChange');
...
INSERT INTO `bi_portal_menu_attribute` VALUES (1,100,'action','1'),(3,101,'action','2'),(4,102,'action','3'),(5,103,'action','4'),(2,100,'autoMaximized','true'),(10,105,'action','5'),(12,104,'action','6'),(15,104,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"btnStyle\":\"success\",\"action\":\"27\"},{\"type\":\"cancel\"}]'),(16,106,'action','7'),(18,107,'action','8'),(20,108,'action','9'),(22,109,'action','10'),(24,110,'action','11'),(26,111,'action','12'),(28,112,'action','13'),(30,113,'action','14'),(32,114,'action','15'),(34,115,'action','16'),(36,16,'action','17'),(38,17,'action','18'),(31,113,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"btnStyle\":\"success\",\"click\":{\"func\":\"Flywet.PortalAction.uploadFiles(dialogId,{actionId:\'22\'})\"}},{\"type\":\"cancel\"}]'),(23,109,'btn','[{\"label\":\"海温预测分析计算\",\"title\":\"海温预测分析计算\",\"action\":\"23\",\"ajaxType\":\"get\"},{\"type\":\"cancel\"}]'),(25,110,'btn','[{\"label\":\" 编辑输入文件namelist\",\"title\":\"编辑输入文件namelist\",\"click\":{\"func\":\"Flywet.PortalAction.openEditFileDialog(\'custom.portal.seasonForecast.file.rootPath\',\'custom.portal.seasonForecast.file.category\',\'custom.portal.seasonForecast.file.fileName\',\'namelist\');\"}},{\"label\":\"海温预测分析计算\",\"title\":\"海温预测分析计算\",\"action\":\"24\",\"ajaxType\":\"get\"},{\"type\":\"cancel\"}]'),(33,114,'btn','[{\"label\":\"月预测评分数据上传\",\"title\":\"月预测评分数据上传\",\"action\":\"34\",\"ajaxType\":\"get\"},{\"label\":\"延伸期预测评分数据上传\",\"title\":\"延伸期预测评分数据上传\",\"action\":\"35\",\"ajaxType\":\"get\"},{\"type\":\"cancel\"}]'),(27,111,'btn','[{\"label\":\"编辑输入文件cityforecast.txt\",\"title\":\"编辑输入文件cityforecast.txt\",\"click\":{\"func\":\"Flywet.PortalAction.openEditFileDialog(\'custom.portal.evaluation.file.rootPath\',\'custom.portal.evaluation.file.category\',\'custom.portal.evaluation.file.fileName\',\'cityforecast.txt\');\"}},{\"label\":\"统计降尺度分析计算\",\"title\":\"统计降尺度分析计算\",\"action\":\"25\",\"ajaxType\":\"get\"},{\"type\":\"cancel\"}]'),(29,112,'btn','[{\"label\":\"编辑输入文件namelist\",\"title\":\"编辑输入文件namelist\",\"click\":{\"func\":\"Flywet.PortalAction.openEditFileDialog(\'custom.portal.processForecast.file.rootPath\',\'custom.portal.processForecast.file.category\',\'custom.portal.processForecast.file.fileName\',\'namelist\');\"}},{\"label\":\"制作142站预测上传文件\",\"title\":\"制作142站预测上传文件\",\"action\":\"26\",\"ajaxType\":\"get\"},{\"type\":\"cancel\"}]'),(46,109,'height','100'),(47,110,'height','100'),(48,111,'height','100'),(49,112,'height','100'),(50,113,'height','200'),(51,114,'height','100'),(39,17,'width','300'),(6,102,'width','800'),(17,106,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"btnStyle\":\"success\",\"action\":\"29\"},{\"type\":\"cancel\"}]'),(52,116,'action','30'),(53,116,'btn','[{\"label\":\"上传文件\",\"title\":\"上传文件\",\"click\":{\"func\":\"Flywet.PortalAction.openUploadOneDialog(dialogId,{text:\'更新文件\',actionId:36})\"}},{\"label\":\"获取数据\",\"title\":\"获取数据\",\"click\":{\"func\":\"monthPredictEvaluateSettingDownloadFile(dialogId,{actionId:37})\"}},{\"label\":\"确定\",\"title\":\"确定\",\"btnStyle\":\"success\",\"action\":\"31\"},{\"type\":\"cancel\"}]'),(54,117,'action','32'),(55,117,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"btnStyle\":\"success\",\"action\":\"33\"},{\"type\":\"cancel\"}]'),(56,116,'autoMaximized','true'),(57,118,'action','37'),(58,18,'action','39'),(59,18,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"btnStyle\":\"success\",\"action\":\"40\"},{\"type\":\"cancel\"}]');
...
INSERT INTO `c_extend_predict` VALUES (0,'2013年05月上旬','2～5日，全省大部分地区有阵雨或雷雨，东北部地区有中到大雨；\r\n10～12日，全省有中到大雨，局部暴雨；\r\n14～15日，全省有小到中雨；\r\n22～24日，全省有小到中雨，局部大雨；\r\n29～31日，全省大部分地区有小到中雨\r\n\r\n\r\n\r\naaaaaaaaaaaaaaa'),(1,'2013年05月下旬','2～5日，全省大部分地区有阵雨或雷雨；\r\n10～12日，全省大部分地区有小到中雨；\r\n14～15日，全省有小到中雨；\r\n22～24日，全省有小到中雨，局部大雨；\r\n29～31日，全省有中到大雨，局部暴雨'),(2,'2013年全年','dfsfsdfsdf\r\n\r\nczczxcxzc\r\ndfsfsdfseeeee\r\n\r\n\r\ndfdfdfdfsfs33333333'),(3,'aadsd','dsfdsfsdfsfsdfcc44'),(5,'的发顺丰','发大水法斯蒂芬斯蒂芬'),(4,'2014年05月上旬','发大水法斯蒂芬斯蒂芬');
...
INSERT INTO `c_month_predict_score` VALUES (1,2013,6,'100 / 67','32 / 23','12 / 5',' 67.1 / 55.2','80.1 / 67.0','67.3 / 55.8',' 0.32 / 0.33'),(2,2013,8,'90 / 67','32 / 23','12 / 5','67.1 / 55.2','80.1 / 67.0','67.3 / 55.8','0.32 / 0.33'),(3,2013,9,'10 / ','d / ',' / ',' / ',' / ',' / ',' / '),(4,2013,12,' / ',' / ',' / ','czxc / ',' / ',' / ',' / ');
...
-- Dump completed on 2014-05-24  8:37:45
