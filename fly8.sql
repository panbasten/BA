...
INSERT INTO `r_func_type` VALUES (0,'root','根',NULL,'功能的根节点',0),(1,'transjob','数据整合',0,'一级节点：数据整合',3),(2,'db','数据源',0,'一级节点：数据源',0),(4,'systools','功能',0,'一级节点：功能',5),(50,'privilege','用户权限',4,'二级节点：功能-用户权限',0),(501,'createuser','创建用户',50,'三级节点：功能-用户权限-创建用户',0),(502,'deluser','删除用户',50,'三级节点：功能-用户权限-删除用户',1),(503,'edituser','编辑当前用户',50,'三级节点：功能-用户权限-编辑当前用户',2),(60,'repository','资源库',4,'二级节点：功能-资源库',1),(601,'connrep','连接资源库',60,'三级节点：功能-资源库-连接资源库',0),(602,'findrep','探测资源库',60,'三级节点：功能-资源库-探测资源库',1),(603,'createrep','创建资源库',60,'三级节点：功能-资源库-创建资源库',2),(70,'file','文件',4,'二级节点：功能-文件',2),(701,'newtrans','新建转换',70,'三级节点：功能-文件-新建转换',0),(702,'newjob','新建作业',70,'三级节点：功能-文件-新建作业',1),(703,'newdb','添加数据库',70,'三级节点：功能-文件-添加数据库',2),(704,'newfs','添加文件系统',70,'三级节点：功能-文件-添加文件系统',3),(80,'operate','操作',4,'二级节点：功能-操作',3),(801,'open','打开',80,'三级节点：功能-操作-打开',0),(802,'fileopen','从文件打开',80,'三级节点：功能-操作-从文件打开',1),(803,'downloadzip','打包下载',80,'三级节点：功能-操作-打包下载',2),(804,'uploadfile','上传文件',80,'三级节点：功能-操作-上传文件',3),(90,'wizard','向导',4,'二级节点：功能-向导',4),(901,'wcreatedb','创建数据库连接',90,'三级节点：功能-向导-创建数据库连接',0),(902,'wsinglecopy','单表复制向导',90,'三级节点：功能-向导-单表复制向导',1),(903,'wmulticopy','多表复制向导',90,'三级节点：功能-向导-多表复制向导',2),(100,'help','帮助',4,'二级节点：功能-帮助',5),(1001,'showstepplugin','显示步骤插件',100,'三级节点：功能-帮助-显示步骤插件',0),(1002,'showjobplugin','显示作业插件',100,'三级节点：功能-帮助-显示作业插件',1),(1003,'about','关于',100,'三级节点：功能-帮助-关于',2),(3,'domain','语义层',0,'一级节点：语义层',1),(5,'fs','文件系统',0,'一级节点：文件系统',4),(6,'report','商业分析',0,'一级节点：报表',2);
...
-- Dump completed on 2013-05-23  7:19:50
