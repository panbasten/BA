...
INSERT INTO `bi_portal_menu_attribute` VALUES (1,100,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(2,100,'method','monthPredict'),(3,101,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(4,101,'method','extendPredict'),(5,102,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(7,103,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(6,102,'method','monthPredictScore'),(8,103,'method','extendPredictScore'),(9,100,'autoMaximized','true'),(10,105,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(11,105,'method','predictSetting'),(12,104,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(13,104,'method','extendSetting'),(14,105,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(15,104,'btn','[{\"label\":\"确定\",\"title\":\"确定\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(16,106,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(17,106,'method','scoreSetting'),(18,107,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(19,107,'method','monthPredictEvaluate'),(20,108,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(21,108,'method','extendPredictPrecipitation'),(22,109,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(23,109,'method','sstMonthPredict'),(24,110,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(25,110,'method','sstQuarterPredict'),(26,111,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(27,111,'method','monthPredictData'),(28,112,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(29,112,'method','extendPredictData'),(30,113,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(31,113,'method','dataUpdate'),(32,114,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(33,114,'method','dataUpload'),(34,115,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(35,115,'method','buzTimed'),(36,16,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(37,16,'method','buzNorms'),(38,17,'cls','com.flywet.cust.p001.portal.ForecastAdaptorImpl'),(39,17,'method','links'),(40,113,'btn','[{\"label\":\"上传输入文件namelist\",\"title\":\"上传输入文件namelist\",\"url\":\"rest/user/create/save\"},{\"label\":\"海温预测分析计算\",\"title\":\"海温预测分析计算\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(41,109,'btn','[{\"label\":\"海温预测分析计算\",\"title\":\"海温预测分析计算\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(42,110,'btn','[{\"label\":\"上传输入文件namelist\",\"title\":\"上传输入文件namelist\",\"url\":\"rest/user/create/save\"},{\"label\":\"海温预测分析计算\",\"title\":\"海温预测分析计算\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(43,114,'btn','[{\"label\":\"上报数据\",\"title\":\"上报数据\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(44,111,'btn','[{\"label\":\"上传输入文件cityforecast.txt\",\"title\":\"上传输入文件cityforecast.txt\",\"url\":\"rest/user/create/save\"},{\"label\":\"统计将尺度分析计算\",\"title\":\"统计将尺度分析计算\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(45,112,'btn','[{\"label\":\"上传输入文件namelist\",\"title\":\"上传输入文件namelist\",\"url\":\"rest/user/create/save\"},{\"label\":\"制作142站预测上传文件\",\"title\":\"制作142站预测上传文件\",\"url\":\"rest/user/create/save\"},{\"type\":\"cancel\"}]'),(46,109,'height','100'),(47,110,'height','100'),(48,111,'height','100'),(49,112,'height','100'),(50,113,'height','200'),(51,114,'height','100');
...
INSERT INTO `r_trans_hop` VALUES (3,3,6,5,'Y'),(2,2,4,3,'Y'),(1,1,1,2,'Y'),(4,4,11,9,'Y'),(5,4,9,12,'Y'),(6,4,10,12,'Y'),(7,4,11,10,'Y'),(8,4,14,7,'Y'),(9,4,15,8,'Y'),(10,4,7,13,'Y'),(11,4,8,13,'Y'),(12,5,16,17,'Y');
...
-- Dump completed on 2013-10-10  7:06:39
