	...
	colors: ['#2f7ed8', '#0d233a', '#8bbc21', '#910000', '#1aadce', '#492970',
 	...
 	plotOptions: {
 		line: { // base series options
 			...
 			dataLabels: $FC.merge($FC.defaultLabelOptions, {
 				align: 'center',
 				enabled: false,
 				formatter: function () {
...
$FC.defaultPlotOptions = $FC.defaultOptions.plotOptions;
$FC.defaultSeriesOptions = $FC.defaultPlotOptions.line;
