 ...
 */
$FC.defaultPlotOptions.pie = $FC.merge($FC.defaultSeriesOptions, {
	borderColor: '#FFFFFF',
	borderWidth: 1,
	center: [null, null],
	clip: false,
 ...
 */
$FC.PiePoint = $FC.extendClass($FC.Point, {
	/**
...
$FC.PieSeries = $FC.extendClass($FC.Series, $FC.PieSeries);
$FC.seriesTypes.pie = $FC.PieSeries;