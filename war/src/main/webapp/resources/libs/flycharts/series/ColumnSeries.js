 ...
 */
$FC.defaultPlotOptions.column = $FC.merge($FC.defaultSeriesOptions, {
	borderColor: '#FFFFFF',
	borderWidth: 1,
	borderRadius: 0,
 ...
 * ColumnSeries object
 */
$FC.ColumnSeries = $FC.extendClass($FC.Series, {
	type: 'column',
	...
	remove: function () {
		...
		$FC.Series.prototype.remove.apply(series, arguments);
	}
});
$FC.seriesTypes.column = $FC.ColumnSeries;