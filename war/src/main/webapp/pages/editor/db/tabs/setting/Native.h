<fly:composition freeLayout="N">
	...
	<fly:inputText id="${formId}:databasePortNumberString" name="${formId}:databasePortNumberString" type="text" value="${dbMeta.databasePortNumberString}" width="60%" class="ui-layout-div ui-helper-clearfix" />
