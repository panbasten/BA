<fly:composition freeLayout="N">
	...
	<fly:labelObject buddy="${formId}:databaseName" text="数据库名称" width="30%" style="margin-bottom:10px;" />
	...
	<fly:labelObject buddy="${formId}:databasePortNumberString" text="端口号" width="30%" style="margin-bottom:10px;" />
	<fly:inputText id="${formId}:databasePortNumberString" name="${formId}:databasePortNumberString" type="text" value="${dbMeta.databasePortNumberString}" width="65%" style="margin-bottom:10px;" />
