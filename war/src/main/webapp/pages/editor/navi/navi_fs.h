<div id="editorContent-navi-${entity.code}" class="fly-editor-tab">
	<div id="editorContent-navi-filesys-bc" class="ui-breadcrumb ui-widget-header ui-helper-clearfix ui-corner-all">
		...
		<div class="ui-toolbar-group-right">
            <fly:pushbutton id="fs-btn-create" iconCls="ui-icon-folder-open" show="N" btnStyle="link"
            	label="新增" title="新增" onclick="Flywet.filesys.create()" />
            <fly:pushbutton id="fs-btn-edit" iconCls="ui-icon-folder-open" show="N" btnStyle="link"
            	label="编辑" title="编辑" onclick="Flywet.filesys.edit()" />
            <fly:pushbutton id="fs-btn-remove" iconCls="ui-icon-folder-open" show="N" btnStyle="link"
            	label="删除" title="删除" onclick="Flywet.filesys.remove()" />
            <fly:pushbutton id="fs-btn-create-dir" iconCls="ui-icon-folder-open" show="N" btnStyle="link"
            	label="创建目录" title="创建目录" onclick="Flywet.filesys.createDir()" />
            <fly:pushbutton id="fs-btn-upload-file" iconCls="ui-icon-folder-open" show="N" btnStyle="link"
            	label="上传" title="上传" onclick="Flywet.filesys.uploadFile()" />
            <fly:pushbutton id="fs-btn-download-file" iconCls="ui-icon-folder-open" show="N" btnStyle="link"
