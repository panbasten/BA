<div id="${editorId}">
	...
	<div id="${editorId}Content" class="fly-flow-content">
		<div id="${editorId}EditorToolbar" class="ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-all">
			...
			<fly:pushbutton id="trans_edit" icon="ui-icon-editor-edit" onclick="Plywet.editor.changeOuterControlType('trans','inner:dealCreateHop','edit');" title="画线" />
			<fly:pushbutton id="trans_magnify" icon="ui-icon-editor-zoom-in" onclick="Plywet.editor.changeOuterControlType('trans','magnify');" title="放大" />
			<fly:pushbutton id="trans_lessen" icon="ui-icon-editor-zoom-out" onclick="Plywet.editor.changeOuterControlType('trans','lessen');" title="缩小" />
			<fly:pushbutton id="trans_partMagnify" icon="ui-icon-editor-zoom-part" onclick="Plywet.editor.changeOuterControlType('trans','partMagnify');" title="局部放大" />
			<fly:pushbutton id="trans_zoom_100" icon="ui-icon-editor-zoom-100" onclick="Plywet.editor.editorZoom100('trans');" title="100%" />
			<fly:pushbutton id="trans_zoom_fit" icon="ui-icon-editor-zoom-fit" onclick="Plywet.editor.editorFix('trans');" title="合适比例" />
			<fly:pushbutton id="trans_screenMove" icon="ui-icon-editor-move" onclick="Plywet.editor.changeOuterControlType('trans','screenMove');" title="屏幕移动" />
			<fly:pushbutton type="separator" />
			<fly:pushbutton id="trans_grid_show" icon="ui-icon-grid-show" onclick="Plywet.editor.showGrid('trans');" title="显示网格" />
			<fly:pushbutton id="trans_grid_close" icon="ui-icon-grid-close" onclick="Plywet.editor.closeGrid('trans');" title="贴近网格" state="disabled" />
			<fly:pushbutton type="separator" />
			...
			<fly:pushbutton id="trans_delete" icon="ui-icon-system-delete" onclick="Plywet.editor.deleteSelectedElFromOutset('trans');" title="删除" state="disabled" />
			<fly:pushbutton type="separator" />
			<fly:pushbutton id="trans_save" icon="ui-icon-save" onclick="Plywet.editor.save('trans');" title="保存" />
