<div id="${editorId}">
	...
	<div id="${editorId}Content" class="fly-flow-content">
		<div id="${editorId}EditorToolbar" class="ui-toolbar ui-widget-header ui-helper-clearfix ui-corner-all">
			...
			<fly:pushbutton id="trans_magnify" icon="ui-icon-editor-zoom-in" onclick="Plywet.editors.trans.action.changeOuterControlType('magnify');" title="放大" />
			<fly:pushbutton id="trans_lessen" icon="ui-icon-editor-zoom-out" onclick="Plywet.editors.trans.action.changeOuterControlType('lessen');" title="缩小" />
			<fly:pushbutton id="trans_partMagnify" icon="ui-icon-editor-zoom-part" onclick="Plywet.editors.trans.action.changeOuterControlType('partMagnify');" title="局部放大" />
			<fly:pushbutton id="trans_zoom_100" icon="ui-icon-editor-zoom-100" onclick="Plywet.editors.trans.action.editorZoom100();" title="100%" />
			<fly:pushbutton id="trans_zoom_fit" icon="ui-icon-editor-zoom-fit" onclick="Plywet.editors.trans.action.editorFix();" title="合适比例" />
			<fly:pushbutton id="trans_screenMove" icon="ui-icon-editor-move" onclick="Plywet.editors.trans.action.changeOuterControlType('screenMove');" title="屏幕移动" />
			<fly:pushbutton type="separator" />
			<fly:pushbutton id="trans_grid_show" icon="ui-icon-grid-show" onclick="Plywet.editors.trans.action.showGrid();" title="显示网格" />
			<fly:pushbutton id="trans_grid_close" icon="ui-icon-grid-close" onclick="Plywet.editors.trans.action.closeGrid();" title="贴近网格" state="disabled" />
			<fly:pushbutton type="separator" />
			...
			<fly:pushbutton id="trans_delete" icon="ui-icon-system-delete" onclick="Plywet.editors.trans.action.deleteSelectedElFromOutset();" title="删除" state="disabled" />
			<fly:pushbutton type="separator" />
			<fly:pushbutton id="trans_save" icon="ui-icon-save" onclick="Plywet.editors.trans.action.save();" title="保存" />
