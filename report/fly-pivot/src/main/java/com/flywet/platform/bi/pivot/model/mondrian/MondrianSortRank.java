...
import com.flywet.platform.bi.pivot.model.olap.query.QuaxChangeListener;
import com.flywet.platform.bi.pivot.model.olap.query.SortRankBase;
...
public class MondrianSortRank extends SortRankBase implements SortRank, QuaxChangeListener {
  ...
  public void addSortToQuery() {
    if (sorting && sortPosMembers != null) {
      ...
      switch (sortMode) {
        case com.flywet.platform.bi.pivot.model.olap.navi.SortRank.ASC :
        case com.flywet.platform.bi.pivot.model.olap.navi.SortRank.DESC :
        case com.flywet.platform.bi.pivot.model.olap.navi.SortRank.BASC :
        case com.flywet.platform.bi.pivot.model.olap.navi.SortRank.BDESC :
          // call sort
          orderAxis(monQuery, sortMode);
          break;
        case com.flywet.platform.bi.pivot.model.olap.navi.SortRank.TOPCOUNT :
          topBottomAxis(monQuery, "TopCount");
          break;
        case com.flywet.platform.bi.pivot.model.olap.navi.SortRank.BOTTOMCOUNT :
