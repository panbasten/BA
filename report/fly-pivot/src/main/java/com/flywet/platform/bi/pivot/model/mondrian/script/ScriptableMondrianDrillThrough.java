package com.flywet.platform.bi.pivot.model.mondrian.script;

import mondrian.olap.Util.PropertyList;
import mondrian.rolap.RolapConnectionProperties;

import com.flywet.platform.bi.pivot.model.core.ExtensionSupport;
import com.flywet.platform.bi.pivot.model.mondrian.MondrianCell;
...
import com.flywet.platform.bi.pivot.model.olap.navi.DrillThrough;
 ...
 */
public class ScriptableMondrianDrillThrough extends ExtensionSupport implements
		DrillThrough {
	...
	public TableModel drillThrough(Cell cell) {
		...
		PropertyList connectInfo = mondrian.olap.Util
		...
		String catalog = connectInfo.get(RolapConnectionProperties.Catalog
				.name());
		String catalogExtension = catalog.replaceFirst(".*/", "").replaceFirst(
				"\\.xml$", ".ext.xml");
