...
/**
 * Browse an OLAP dataSource in order to retrieve specific Olap Items as
 * dimensions, levels, members
 */
public interface OlapDiscoverer {
	 ...
	 * @throws OlapException
	 */
	public java.util.List discoverDim(String cat, String cube)
			throws OlapException;
	 ...
	 * @throws OlapException
	 */
	public java.util.List discoverLev(String cat, String cube,
			String dimension, String hier) throws OlapException;
	 ...
	 * @throws OlapException
	 */
	public java.util.List discoverMem(String cat, String cube,
	 ...
	 * @throws OlapException
	 */
	public java.util.List discoverMemTree(String cat, String cube,
			String member, int treeop) throws OlapException;

	/**
	 * retrieve a map describing the datasource
	 * 
	 * @return map of key, value strings keys are, for instance, DataSourceName
	 ...
	 * @throws OlapException
	 */
	public java.util.List discoverProp(String cat, String cube,
			String dimension, String hierarchy, String level)
			throws OlapException;
	 ...
	 * @return List of OlapItems for the members
	 * @throws OlapException
	 * @see com.flywet.platform.bi.pivot.model.olap.model.OlapDiscoverer#discoverProp
	 */
	public java.util.List discoverSapVar(String cat, String cube)
			throws OlapException;
