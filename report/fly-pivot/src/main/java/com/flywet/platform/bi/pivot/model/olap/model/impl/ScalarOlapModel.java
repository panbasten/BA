...
/**
 * A ScalarOlapModel is an OlapModel that contains a single cell. It is
 * 1-dimensional with Measures as its only dimension.
 * <p />
 * Properties:
 * <dl>
 * <dt>caption</dt>
 * <dd>Caption of the only measure</dd>
 * <dt>result.value</dt>
 * <dd>value of the single cell</dd>
 * <dt>result.formattedValue</dt>
 * <dd>formatted value of the single cell</dd>
 * </dl>
 * 
 * @author av
 * @since 21.04.2005
