...
import com.flywet.platform.bi.pivot.model.olap.navi.ChangeSlicer;
...
public class MondrianChangeSlicer extends ExtensionSupport implements ChangeSlicer {
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.ChangeSlicer#getSlicer()
   */
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.ChangeSlicer#setSlicer(Member[])
   */
