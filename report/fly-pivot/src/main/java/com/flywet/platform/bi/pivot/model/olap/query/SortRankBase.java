...
import com.flywet.platform.bi.pivot.model.core.ModelSupport;
...
import com.flywet.platform.bi.pivot.model.olap.model.OlapUtils;
...
import com.flywet.platform.bi.pivot.model.olap.query.QueryAdapter.QueryAdapterHolder;
...
public abstract class SortRankBase
  ...
  protected int sortMode = com.flywet.platform.bi.pivot.model.olap.navi.SortRank.ASC;
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.SortRank#getTopBottomCount()
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.mondrian.olap.navi.SortRank#setTopBottomCount(int)
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.SortRank#getSortMode()
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.SortRank#setSortMode(int)
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.SortRank#isCurrentSorting(Position)
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.navi.SortRank#isSortable(Position)
   */
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.SortRank#sort(Axis, Position)
  ...
  public void reset() {
    ...
    topBottomCount = 10;
    sortMode = com.flywet.platform.bi.pivot.model.olap.navi.SortRank.ASC;
    sorting = false;
    sortPosMembers = null;
