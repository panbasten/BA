...
import com.flywet.platform.bi.pivot.model.olap.model.OlapModel;
import com.flywet.platform.bi.pivot.model.olap.model.Result;
import com.flywet.platform.bi.pivot.model.olap.navi.SortRank;
import com.flywet.platform.bi.pivot.model.olap.query.ExpBean;
import com.flywet.platform.bi.pivot.model.olap.query.MdxOlapModel;
import com.flywet.platform.bi.pivot.model.olap.query.Memento;
import com.flywet.platform.bi.pivot.model.olap.query.PositionNodeBean;
import com.flywet.platform.bi.pivot.model.olap.query.QueryAdapter;
import com.flywet.platform.bi.pivot.model.wcf.Bookmarkable;
...
public class MondrianModel extends MdxOlapModel implements OlapModel,
	 ...
	 */
	static final String LOGICAL_MDX_PROP = "com.flywet.platform.bi.pivot.model.mondrian.logical.mdx";
	 ...
	 */
	public static final String CELL_LIMIT_PROP = "com.flywet.platform.bi.pivot.model.mondrian.cell.limit";
	 ...
	 * 
	 * @see com.flywet.platform.bi.pivot.model.olap.model.OlapModel#getResult()
	...
	/**
	 * @see com.flywet.platform.bi.pivot.model.olap.model.OlapModel#getDimensions()
	 */
	...
	/**
	 * @see com.flywet.platform.bi.pivot.model.olap.model.OlapModel#getMeasures()
	 */
	...
	public void initialize() throws OlapException {
		...
		if (dynresolver != null && dynresolver.length() > 0) {
			properties.put(RolapConnectionProperties.DynamicSchemaProcessor
					.name(), dynresolver);
			updatedProperties = true;
		}
		if (dynLocale != null) {
		...
		if (dataSourceChangeListener != null
			...
			properties.put(RolapConnectionProperties.DataSourceChangeListener
					.name(), dataSourceChangeListener);
			updatedProperties = true;
		}
	...
	private void addHierarchy(mondrian.olap.Hierarchy monHierarchy,
		...
		if (!hHierarchies.containsKey(uniqueName)) {
			...
			for (int i = 0; i < monLevels.size(); i++) {
				this
						.addLevel((mondrian.olap.Level) monLevels.get(i),
								hierarchy);
			}
		}
	}
