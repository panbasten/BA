...
import com.flywet.platform.bi.pivot.model.util.CubeIndexIterator;
...
public abstract class ResultBase implements Result {
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.model.Result#getAxes()
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.model.Result#getCells()
   */
