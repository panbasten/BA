...
import com.flywet.platform.bi.pivot.model.olap.model.Alignable;
...
import com.flywet.platform.bi.pivot.model.olap.model.impl.PropertyImpl;
import com.flywet.platform.bi.pivot.model.olap.query.MDXMember;
...
public class MondrianMember implements Member, MDXMember {
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.model.Member#getRootDistance()
   */
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.model.Member#getLevel()
   */
  ...
  /**
   * @return parent
   * @see com.flywet.platform.bi.pivot.model.olap.query.MDXMember#getParent()
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.model.MDXMember#getParentUniqueName()
   */
