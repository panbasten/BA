...
class Yylex implements java_cup.runtime.Scanner {
	...
	private final int yy_state_dtrans[] = { 0, 74, 76 };
			...
			if (YY_F != yy_next_state) {
				...
				if (YY_NO_STATE == yy_last_accept_state) {
					...
					case -18:
						break;
					case 18: {
						Double d = new Double(yytext());
						return new Symbol(sym.NUMBER, d);
					}
					case -19:
						break;
					case 19: { /* ignore white space. */
					}
					case -20:
						break;
					case 20: {
						yybegin(AFTER_AS1);
						return new Symbol(sym.AS, "AS");
					}
					case -21:
						break;
					case 21: {
