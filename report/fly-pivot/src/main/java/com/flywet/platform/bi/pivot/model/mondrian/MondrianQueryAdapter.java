...
public class MondrianQueryAdapter extends QueryAdapter implements QuaxChangeListener {
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.navi.DrillExpandMember#canExpand(Member)
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.DrillExpandMember#canCollapse(Member)
