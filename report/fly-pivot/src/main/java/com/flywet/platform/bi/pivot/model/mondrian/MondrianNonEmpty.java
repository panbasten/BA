...
import com.flywet.platform.bi.pivot.model.olap.navi.NonEmpty;
...
public class MondrianNonEmpty extends ExtensionSupport implements NonEmpty {
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.NonEmpty#isNonEmpty()
   */
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.navi.NonEmpty#setNonEmpty(boolean)
   */
