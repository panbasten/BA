...
/**
 * finds a group (span) of positions that are related in terms of a start
 * position and a member. The group consists of the positions before and after
 * the start position, that share equal members on the member's level and on the
 * higher levels.
 * <p>
 * Example 1: returns the first 2 positions. A's and I's are equal within the
 * group
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Example 2: returns the first 2 positions. A's and I's are equal within the
 * group
 * 
 * <pre>
 * A I U  
