...
public interface Model extends Bookmarkable {
	/**
	 * returns the extension if this model instance supports it. Returns null if
	 * the extension is not supported.
	 */
	Extension getExtension(String id);

	/**
	 * returns a Map containing all extensions JSP scripting. Key is the
	 * extension id, value is the extension.
	 */
	Map getExtensions();
	...
	/**
	 * Returns the top element of the decorator chain. If any extensions
	 * decorate the model, a decorator chain is built and its head is returned.
	 * Otherwise this is returned
	 */
	public Model getTopDecorator();

	/**
	 * Returns the bottom element of the decorator chain. The returned model
	 * does not decorate any other model, its the end of the chain.
	 */
