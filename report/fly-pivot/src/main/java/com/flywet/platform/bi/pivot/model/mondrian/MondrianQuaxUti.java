...
import com.flywet.platform.bi.pivot.model.olap.query.Quax;
import com.flywet.platform.bi.pivot.model.olap.query.QuaxUti;
import com.flywet.platform.bi.pivot.model.olap.query.SetExp;
import com.flywet.platform.bi.pivot.model.olap.query.Quax.CannotHandleException;
...
public class MondrianQuaxUti implements QuaxUti {
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#isMemberOnToplevel
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#createMemberSet(java.util.List)
   */
   ...
   * @see QuaxUti#objForMember(com.flywet.platform.bi.pivot.model.olap.model.Member)
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#objForDim
   */
   ...
   *
   * @see QuaxUti#dimForMember(com.flywet.platform.bi.pivot.model.olap.model.Member)
   */
   ...
   * @see QuaxUti#hierForMember(com.flywet.platform.bi.pivot.model.olap.model.Member)
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#funCallName
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#checkParent
   */
   ...
   *
   * @see QuaxUti#isDescendantOfMemberInFunCall(Object, com.flywet.platform.bi.pivot.model.olap.model.Member)
   */
   ...
   * @see QuaxUti#topLevelMembers(com.flywet.platform.bi.pivot.model.olap.model.Hierarchy, boolean)
   */
   ...
   * @see QuaxUti#getParentLevel(com.flywet.platform.bi.pivot.model.olap.model.Level)
   */
  ...
  /**
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#isFunCall
   */
   ...
   * @see QuaxUti#equalMember(java.lang.Object, com.flywet.platform.bi.pivot.model.olap.model.Member)
   */
   ...
   *
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#canHandle(java.lang.Object)
   */
   ...
   * @see com.flywet.platform.bi.pivot.model.olap.query.QuaxUti#getChildren(java.lang.Object)
   */
