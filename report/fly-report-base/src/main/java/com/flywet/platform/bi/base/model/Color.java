...
import com.flywet.platform.bi.base.exceptions.ReportException;
import com.flywet.platform.bi.base.style.ISpreadSheetStyle;
...
public class Color implements java.io.Serializable, ISpreadSheetStyle {
	...
	public static Color getInstance(int r, int g, int b) throws ReportException {
	 ...
	 * @throws ReportException
	 */
	public static Color getInstance(String color) throws ReportException {
		// 1.十六进制颜色字符串
	...
	public Color brighter() throws ReportException {
		...
		return getInstance(Math.min((int) (r / FACTOR), 255), Math.min(
				(int) (g / FACTOR), 255), Math.min((int) (b / FACTOR), 255), a);
	}
	...
	private static void testColorValueRange(int r, int g, int b, int a)
		...
		if (rangeError) {
			throw new ReportException("颜色参数超出预期值，" + badString);
		}
	}
