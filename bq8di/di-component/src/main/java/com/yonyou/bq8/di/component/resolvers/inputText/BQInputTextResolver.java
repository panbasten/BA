package com.yonyou.bq8.di.component.resolvers.inputText;
...
public class BQInputTextResolver extends BaseComponentResolver implements
	...
	public void renderSub(Node node, HTMLWriter html, List<String> script,
		...
		try {
			...
			if (onchange != null || interaction != null) {
				...
				onchange = (interaction != null) ? "YonYou.interaction.action("
						+ val + "," + interaction + ");"
			...
			throw new DIPageException("InputText解析出现错误。");
		}
	}
}
