...
public class HTML {
	...
	public static final String COMPONENT_TYPE_BQ_PREFIX = "bq:";
	...
	public static final String COMPONENT_TYPE_FOR_EACH = COMPONENT_TYPE_BQ_PREFIX
			+ "foreach";
	public static final String COMPONENT_TYPE_INCLUDE = COMPONENT_TYPE_BQ_PREFIX
			+ "include";
	public static final String COMPONENT_TYPE_COMPOSITION = COMPONENT_TYPE_BQ_PREFIX
			+ "composition";;

	public static final String COMPONENT_TYPE_LAYOUT = COMPONENT_TYPE_BQ_PREFIX
			+ "Layout";
	public static final String COMPONENT_TYPE_LAYOUT_ITEM = COMPONENT_TYPE_BQ_PREFIX
			+ "LayoutItem";
	public static final String COMPONENT_TYPE_INPUT_TEXT = COMPONENT_TYPE_BQ_PREFIX
			+ "InputText";
	public static final String COMPONENT_TYPE_SELECT_MENU = COMPONENT_TYPE_BQ_PREFIX
			+ "SelectMenu";
	public static final String COMPONENT_TYPE_OPTION = COMPONENT_TYPE_BQ_PREFIX
			+ "Option";
	public static final String COMPONENT_TYPE_OPTIONS = COMPONENT_TYPE_BQ_PREFIX
			+ "Options";
	public static final String COMPONENT_TYPE_LABEL_OBJECT = COMPONENT_TYPE_BQ_PREFIX
			+ "LabelObject";
	public static final String COMPONENT_TYPE_BUTTON = COMPONENT_TYPE_BQ_PREFIX
			+ "Button";
	public static final String COMPONENT_TYPE_TAB_VIEW = COMPONENT_TYPE_BQ_PREFIX
			+ "TabView";
	public static final String COMPONENT_TYPE_TAB = COMPONENT_TYPE_BQ_PREFIX
			+ "Tab";
	public static final String COMPONENT_TYPE_MESSAGEBOX = COMPONENT_TYPE_BQ_PREFIX
			+ "Messagebox";
	public static final String COMPONENT_TYPE_FLOWCHART = COMPONENT_TYPE_BQ_PREFIX
			+ "Flowchart";
	public static final String COMPONENT_TYPE_TREE = COMPONENT_TYPE_BQ_PREFIX
			+ "Tree";
	public static final String COMPONENT_TYPE_TREE_NODE = COMPONENT_TYPE_BQ_PREFIX
			+ "TreeNode";
	public static final String COMPONENT_TYPE_BREAD_CRUMB = COMPONENT_TYPE_BQ_PREFIX
			+ "BreadCrumb";
	public static final String COMPONENT_TYPE_BREAD_CRUMB_NODE = COMPONENT_TYPE_BQ_PREFIX
			+ "BreadCrumbNode";
	public static final String COMPONENT_TYPE_BROWSE = COMPONENT_TYPE_BQ_PREFIX
			+ "Browse";
	public static final String COMPONENT_TYPE_BROWSE_NODE = COMPONENT_TYPE_BQ_PREFIX
			+ "BrowseNode";
	public static final String COMPONENT_TYPE_PANEL = COMPONENT_TYPE_BQ_PREFIX
			+ "Panel";

	public static final String COMPONENT_TYPE_GRID = COMPONENT_TYPE_BQ_PREFIX
			+ "Grid";
	public static final String COMPONENT_TYPE_VALIDATE_BOX = COMPONENT_TYPE_BQ_PREFIX
			+ "ValidateBox";
	public static final String COMPONENT_TYPE_NUMBER_BOX = COMPONENT_TYPE_BQ_PREFIX
			+ "NumberBox";
	public static final String COMPONENT_TYPE_DATE_BOX = COMPONENT_TYPE_BQ_PREFIX
			+ "DateBox";
	public static final String COMPONENT_TYPE_COMBO = COMPONENT_TYPE_BQ_PREFIX
			+ "Combo";
	public static final String COMPONENT_TYPE_COMBO_BOX = COMPONENT_TYPE_BQ_PREFIX
			+ "ComboBox";
	public static final String COMPONENT_TYPE_COMBO_GRID = COMPONENT_TYPE_BQ_PREFIX
			+ "ComboGrid";
	public static final String COMPONENT_TYPE_COMBO_TREE = COMPONENT_TYPE_BQ_PREFIX
			+ "ComboTree";
	...
	public static Map<String, Object> getAttributesMap(NamedNodeMap nnm,
			String[] dis, BQVariableResolver attrs) throws DIPageException {
		try {
	...
	public static void getAttributesString(NamedNodeMap nnm, String[] dis,
			HTMLWriter html, BQVariableResolver attrs) throws DIPageException {
		Map<String, Boolean> disMap = null;
		if (dis != null) {
			disMap = new HashMap<String, Boolean>();
			for (String d : dis) {
