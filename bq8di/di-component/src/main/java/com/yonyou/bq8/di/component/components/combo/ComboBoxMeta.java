...
public class ComboBoxMeta extends ComboMeta implements ComponentMetaInterface {
	...
	public ComboBoxMeta setLocalData(List<Object> list) throws DIJSONException {
	...
	public ComboBoxMeta setRemoteData(String method, String url,
			Map<String, Object> data) throws DIJSONException {
	...
	public ComboBoxMeta setValueField(String val) throws DIJSONException {
		this.addAttribute(ATTR_VALUE_FIELD, val);
		return this;
	}

	public ComboBoxMeta setTextField(String val) throws DIJSONException {
		this.addAttribute(ATTR_TEXT_FIELD, val);
		return this;
	}

	public ComboBoxMeta setFilter(String val) throws DIJSONException {
		this.addAttribute(ATTR_FILTER, val);
		return this;
	}

	public ComboBoxMeta setFormatter(String val) throws DIJSONException {
		this.addAttribute(ATTR_FORMATTER, val);
		return this;
	}

	public ComboBoxMeta setLoader(String val) throws DIJSONException {
		this.addAttribute(ATTR_LOADER, val);
		return this;
	}

	public ComboBoxMeta setOnBeforeLoad(String val) throws DIJSONException {
		this.addAttribute(ATTR_ON_BEFORE_LOAD, val);
		return this;
	}

	public ComboBoxMeta setOnLoadSuccess(String val) throws DIJSONException {
		this.addAttribute(ATTR_ON_LOAD_SUCCESS, val);
		return this;
	}

	public ComboBoxMeta setOnLoadError(String val) throws DIJSONException {
		this.addAttribute(ATTR_ON_LOAD_ERROR, val);
		return this;
	}

	public ComboBoxMeta setOnSelect(String val) throws DIJSONException {
		this.addAttribute(ATTR_ON_SELECT, val);
		return this;
	}

	public ComboBoxMeta setOnUnselect(String val) throws DIJSONException {
