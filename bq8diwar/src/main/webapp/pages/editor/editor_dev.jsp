...
<html>
	<head>
		...
		<!-- replace href="<%=path%>/resources/styles/hb.compressed.css" type="style" -->
		<link href="<%=path%>/resources/styles/hb.css" rel="stylesheet"
			type="text/css" />
		<!-- replace end -->
		...
		<script type="text/javascript"
			src="<%=path%>/resources/scripts/hb.js"></script>
		<script type="text/javascript"
			src="<%=path%>/resources/scripts/hb_browse.js"></script>
		<script type="text/javascript"
			src="<%=path%>/resources/scripts/hb_editor.js"></script>
		<script type="text/javascript"
			src="<%=path%>/resources/scripts/hb_database.js"></script>
		<script type="text/javascript"
			src="<%=path%>/resources/scripts/hb_filesys.js"></script>
		<script type="text/javascript"
			src="<%=path%>/resources/scripts/hb_sysTools.js"></script>
		<script type="text/javascript"
	...
	<body id="idBody">
		...
		<div class="ui-layout-south hb-south">
			<span style="margin-left:10px;font-weight:bold;">当前位置:&nbsp;</span><span>当前操作位置-转换区</span>
			<div style="float:right;"><span id="idUser" class="hb-userinfo">用户:Admin</span><div class="hb-exit"></div></div>
		</div>
		...
		<div class="hb-container" >
			<div id="editorContent" class="ui-editorContent" style="top:12px;">
				...
				<div id="editorContentPanels" class="hb-panels">
