...
YonYou.widget.EasyTabs = function(cfg) {
	this.cfg = cfg;
	this.id = this.cfg.id;
...
YonYou.extend(YonYou.widget.EasyTabs, YonYou.widget.BaseWidget);
 ...
 */
YonYou.widget.EasyTabs.prototype.addTab = function(cfg){
 ...
 * 匹配
 */
YonYou.widget.EasyTabs.prototype.hasMatch = function(hash){
 ...
 * 选择
 */
YonYou.widget.EasyTabs.prototype.select = function(tabSelector){
 ...
 * 是否激活
 */
YonYou.widget.EasyTabs.prototype.isActive = function(tabSelector){
 ...
 * @param modify 是否修改
 */
YonYou.widget.EasyTabs.prototype.setTabModify = function(tabSelector,modify){
