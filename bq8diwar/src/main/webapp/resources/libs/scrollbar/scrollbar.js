YonYou.widget.Scrollbar = function(cfg) {
	this.cfg = cfg;
	this.id = this.cfg.id;
...
YonYou.extend(YonYou.widget.Scrollbar, YonYou.widget.BaseWidget);

YonYou.widget.Scrollbar.prototype.reinit = function(){
	this._rePosition();
	this.switchScroll();
	this.currentTop = 0;
	this.currentLeft = 0;
...
YonYou.widget.Scrollbar.prototype._isVScroll = function() {
	return this.type == 'vertical';
};

YonYou.widget.Scrollbar.prototype._createDom = function(){
...
YonYou.widget.Scrollbar.prototype._moveMin=function() {
	if(this._isVScroll()){
...
YonYou.widget.Scrollbar.prototype._moveMax = function(){
	if(this._isVScroll()){
		this.currentTop=this.currentTop+this.stepSize;
		this.switchScroll();
		this.$tabGroup.animate({top:this.currentTop},"slow");
...
YonYou.widget.Scrollbar.prototype.switchScroll = function(){
	if (this._isVScroll()) {
...
YonYou.widget.Scrollbar.prototype._rePosition = function(){
	if (this._isVScroll()) {
		var roof = 0,
			floor = this.$container.height(),
			left = 0;
