(function($){
    ...
    function _getOptionArr(target){
        ...
        function _addOption(aa, jqobj){
            jqobj.children("li").each(function(){
                var temp = $(this);
                var jsonObj = $.extend({}, YonYou.parseOptions(this, ["id", "iconCls", "state"]), {
    ...
    $.fn.tree.parseOptions = function(target){
        var t = $(target);
        return $.extend({}, YonYou.parseOptions(target, ["url", "method", {
            checkbox: "boolean",
...
YonYou.widget.EasyTree=function(cfg){
	this.cfg=cfg;    
...
YonYou.extend(YonYou.widget.EasyTree, YonYou.widget.BaseWidget);
YonYou.widget.EasyTree.prototype.transdata=function(initdata){
	if(initdata){
