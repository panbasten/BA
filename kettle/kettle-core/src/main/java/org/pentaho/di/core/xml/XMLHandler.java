...
public class XMLHandler {
	...
	public static final boolean containsTagName(Node node, String attribute) {
		return getTagAttribute(node, attribute) != null;
	}
	...
	public static final Document loadXMLFile(FileObject fileObject,
		...
		try {
			...
			throw new KettleXMLException("Unable to read file ["
	...
	public static final Document loadXMLFile(URL resource)
		...
		try {
			...
			throw new KettleXMLException(
					"Error reading information from resource", e);
		}
	}
	...
	public static final Document loadXMLString(String string,
		...
		try {
			...
			throw new KettleXMLException(
					"Error reading information from XML string : " + Const.CR
							+ string, e);
		}
	}
