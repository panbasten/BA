...
public class Const {
	...
	/**
	 * Path to the users home directory (keep this entry above references to
	 * getKettleDirectory())
	 * 
	 * @deprecated Use {@link Const.getUserHomeDirectory()} instead.
	 */
	@Deprecated
	public static final String USER_HOME_DIRECTORY = NVL(System
			.getProperty("FLYWET_HOME"), System.getProperty("user.home"));
	...
	public static final String DEFAULT_PLUGIN_BASE_FOLDERS = "plugins,"
			+ (Const.isEmpty(getBAHomeDirectory()) ? "" : getBAHomeDirectory()
					+ FILE_SEPARATOR + "plugins,") + getKettleDirectory()
			+ FILE_SEPARATOR + "plugins";
	...
	/**
	 * Specifies the number of pixels to the right we have to go in dialog
	 * boxes.
	 */
	public static final int RIGHT = 400;

	/**
	 * Specifies the length (width) of fields in a number of pixels in dialog
	 * boxes.
	 */
	...
	/**
	 * The default percentage of the width of screen where we consider the
	 * middle of a dialog.
	 */
	...
	/**
	 * The discriptions of the possible extensions a transformation XML file can
	 * have.
	 */
	...
	/** The possible extensions a transformation XML file can have. */
	public static final String STRING_TRANS_FILTER_EXT[] = new String[] {
			"*.ktr;*.xml", "*.xml", "*.*" };
	...
	public static final String STRING_JOB_FILTER_EXT[] = new String[] {
			"*.kjb;*.xml", "*.xml", "*.*" };
	...
	/** The job name */
	public static final String INTERNAL_VARIABLE_JOB_NAME = INTERNAL_VARIABLE_PREFIX
			+ ".Job.Name";
	...
	/** The job run ID */
	public static final String INTERNAL_VARIABLE_JOB_RUN_ID = INTERNAL_VARIABLE_PREFIX
			+ ".Job.Run.ID";
	...
	public static final String INTERNAL_VARIABLE_CLUSTER_SIZE = INTERNAL_VARIABLE_PREFIX
			+ ".Cluster.Size";
	...
	public static final String INTERNAL_VARIABLE_CLUSTER_MASTER = INTERNAL_VARIABLE_PREFIX
			+ ".Cluster.Master";
	 ...
	 */
	public static final String INTERNAL_VARIABLE_CLUSTER_RUN_ID = INTERNAL_VARIABLE_PREFIX
			+ ".Cluster.Run.ID";
	...
	/** The step name */
	public static final String INTERNAL_VARIABLE_STEP_NAME = INTERNAL_VARIABLE_PREFIX
			+ ".Step.Name";

	/** The step copy nr */
	public static final String INTERNAL_VARIABLE_STEP_COPYNR = INTERNAL_VARIABLE_PREFIX
			+ ".Step.CopyNr";
	...
	/**
	 * If you set this environment variable you can limit the log size of all
	 * transformations and jobs that don't have the "log size limit" property
	 * set in their respective properties.
	 */
	public static final String KETTLE_LOG_SIZE_LIMIT = "KETTLE_LOG_SIZE_LIMIT";

	/**
	 * The name of the variable that defines the log database connection by
	 * default for all transformations
	 */
	public static final String KETTLE_TRANS_LOG_DB = "KETTLE_TRANS_LOG_DB";

	/**
	 * The name of the variable that defines the logging schema for all
	 * transformations
	 */
	public static final String KETTLE_TRANS_LOG_SCHEMA = "KETTLE_TRANS_LOG_SCHEMA";

	/**
	 * The name of the variable that defines the logging table for all
	 * transformations
	 */
	...
	/**
	 * The name of the variable that defines the transformation performance log
	...
	/**
	 * The name of the variable that defines the transformation performance log
	 * database connection by default for all transformations
	 */
	...
	/**
	 * The name of the variable that defines the job entry log database by
	 * default for all jobs
	 */
	public static final String KETTLE_JOBENTRY_LOG_DB = "KETTLE_JOBENTRY_LOG_DB";

	/**
	 * The name of the variable that defines the job entry log schema by default
	 * for all jobs
	 */
	public static final String KETTLE_JOBENTRY_LOG_SCHEMA = "KETTLE_JOBENTRY_LOG_SCHEMA";

	/**
	 * The name of the variable that defines the job entry log table by default
	 * for all jobs
	 */
	public static final String KETTLE_JOBENTRY_LOG_TABLE = "KETTLE_JOBENTRY_LOG_TABLE";

	/**
	 * The name of the variable that defines the steps log database by default
	 * for all transformations
	 */
	public static final String KETTLE_STEP_LOG_DB = "KETTLE_STEP_LOG_DB";

	/**
	 * The name of the variable that defines the steps log schema by default for
	 * all transformations
	 */
	public static final String KETTLE_STEP_LOG_SCHEMA = "KETTLE_STEP_LOG_SCHEMA";

	/**
	 * The name of the variable that defines the steps log table by default for
	 * all transformations
	 */
	public static final String KETTLE_STEP_LOG_TABLE = "KETTLE_STEP_LOG_TABLE";

	/**
	 * The name of the variable that defines the log channel log database by
	 * default for all transformations and jobs
	 */
	public static final String KETTLE_CHANNEL_LOG_DB = "KETTLE_CHANNEL_LOG_DB";

	/**
	 * The name of the variable that defines the log channel log schema by
	 * default for all transformations and jobs
	 */
	public static final String KETTLE_CHANNEL_LOG_SCHEMA = "KETTLE_CHANNEL_LOG_SCHEMA";

	/**
	 * The name of the variable that defines the log channel log table by
	 * default for all transformations and jobs
	 */
	public static final String KETTLE_CHANNEL_LOG_TABLE = "KETTLE_CHANNEL_LOG_TABLE";

	/**
	 * The name of the variable that defines the checkpoint log database by
	 * default for all jobs
	 */
	public static final String KETTLE_CHECKPOINT_LOG_DB = "KETTLE_CHECKPOINT_LOG_DB";

	/**
	 * The name of the variable that defines the checkpoint log schema by
	 * default for all jobs
	 */
	public static final String KETTLE_CHECKPOINT_LOG_SCHEMA = "KETTLE_CHECKPOINT_LOG_SCHEMA";

	/**
	 * The name of the variable that defines the checkpoint log table by default
	 * for all jobs
	 */
	public static final String KETTLE_CHECKPOINT_LOG_TABLE = "KETTLE_CHECKPOINT_LOG_TABLE";

	/**
	 * Name of the environment variable to set the location of the shared object
	 * file (xml) for transformations and jobs
	 */
	public static final String KETTLE_SHARED_OBJECTS = "KETTLE_SHARED_OBJECTS";

	/**
	 * System wide flag to drive the evaluation of null in ValueMeta. If this
	 * setting is set to "Y", an empty string and null are different. Otherwise
	 * they are not.
	 */
	public static final String KETTLE_EMPTY_STRING_DIFFERS_FROM_NULL = "KETTLE_EMPTY_STRING_DIFFERS_FROM_NULL";

	/**
	 * System wide flag to set the maximum number of log lines that are kept
	 * internally by Kettle. Set to 0 to keep all rows (default)
	 */
	public static final String KETTLE_MAX_LOG_SIZE_IN_LINES = "KETTLE_MAX_LOG_SIZE_IN_LINES";

	/**
	 * System wide flag to set the maximum age (in minutes) of a log line while
	 * being kept internally by Kettle. Set to 0 to keep all rows indefinitely
	 * (default)
	 */
	public static final String KETTLE_MAX_LOG_TIMEOUT_IN_MINUTES = "KETTLE_MAX_LOG_TIMEOUT_IN_MINUTES";

	/**
	 * This environment variable will set a time-out after which waiting,
	 * completed or stopped transformations and jobs will be automatically
	...
	/**
	 * System wide parameter: the maximum number of step performance snapshots
	 * to keep in memory. Set to 0 to keep all snapshots indefinitely (default)
	 */
	public static final String KETTLE_STEP_PERFORMANCE_SNAPSHOT_LIMIT = "KETTLE_STEP_PERFORMANCE_SNAPSHOT_LIMIT";

	/**
	 * A variable to configure the maximum number of job trackers kept in
	 * memory.
	 */
	public static final String KETTLE_MAX_JOB_TRACKER_SIZE = "KETTLE_MAX_JOB_TRACKER_SIZE";

	/**
	 * A variable to configure the maximum number of job entry results kept in
	 * memory for logging purposes.
	 */
	public static final String KETTLE_MAX_JOB_ENTRIES_LOGGED = "KETTLE_MAX_JOB_ENTRIES_LOGGED";

	/**
	 * A variable to configure the maximum number of logging registry entries
	 * kept in memory for logging purposes.
	 */
	public static final String KETTLE_MAX_LOGGING_REGISTRY_SIZE = "KETTLE_MAX_LOGGING_REGISTRY_SIZE";

	/**
	 * The name of the system wide variable that can contain the name of the SAP
	 * Connection factory for the test button in the DB dialog. This defaults to
	 */
	...
	/**
	 * Name of the environment variable to specify additional classes to scan
	...
	/**
	 * The name of the environment variable that will contain the alternative
	 * location of the kettle-steps.xml file
	 */
	...
	/**
	 * The name of the environment variable that will contain the alternative
	 * location of the kettle-job-entries.xml file
	 */
	...
	/**
	 * The name of the environment variable that will contain the alternative
	 * location of the kettle-servlets.xml file
	 */
	public static final String KETTLE_CORE_SERVLETS_FILE = "KETTLE_CORE_SERVLETS_FILE";

	/**
	 * The name of the variable that optionally contains an alternative rowset
	 * get timeout (in ms). This only makes a difference for extremely short
	...
	/**
	 * The name of the variable that optionally contains an alternative rowset
	 * put timeout (in ms). This only makes a difference for extremely short
	 * lived transformations.
	 */
	public static final String KETTLE_ROWSET_PUT_TIMEOUT = "KETTLE_ROWSET_PUT_TIMEOUT";

	/**
	 * Set this variable to Y if you want to test a more efficient batching row
	 * set. (default = N)
	 */
	...
	/**
	 * The XML file that contains the list of native Kettle repository types
	 * (DB, File, etc)
	 */
	public static final String XML_FILE_KETTLE_REPOSITORIES = "kettle-repositories.xml";

	/**
	 * The XML file that contains the list of native Kettle database types
	 * (MySQL, Oracle, etc)
	 */
	 ...
	 * rounding TODO: make the rounding itself optional in the Props for
	 * performance reasons.
	 * 
	 * @param f
	 *            The value to round
	 ...
	 * public static final float round(double f, int places) { float temp =
	...
	/**
	 * Looks up the user's home directory (or FLYWET_HOME) for every invocation.
	 ...
	 *         {@code FLYWET_HOME} if set.
	 */
	public static final String getUserHomeDirectory() {
		return NVL(System.getProperty("FLYWET_HOME"), System
	...
	public static final String getKettleDirectory() {
		return getUserHomeDirectory() + FILE_SEPARATOR
				+ BasePropertyHandler.getProperty("userBaseDir", ".flywet");
	}
	...
	public static final String getPageTemplateDirectory() {
		return getKettleDirectory() + FILE_SEPARATOR + ".page";
	}

	/**
	 * Returns the path to the Kettle local (current directory) repositories XML
	 * file.
	 * 
	...
	public static final String getKettleUserRepositoriesFile() {
		return getKettleDirectory() + FILE_SEPARATOR
				+ getKettleLocalRepositoriesFile();
	}

	/**
	 * Returns the path to the Kettle local (current directory) Carte password
	 * file:
	 * <p>
	 * ./pwd/kettle.pwd<br>
	 * 
	 ...
	 * FLYWET_HOME as an environment variable, you can use %%FLYWET_HOME%% in
	 ...
	 * @deprecated use StringUtil.environmentSubstitute(): handles both Windows
	...
	/**
	 * Check if the string array supplied is empty. A String array is empty when
	 * it is null or when the number of elements is 0
	 * 
	 * @param string
	...
	public static final ClassLoader createNewClassLoader()
		...
		try {
			...
			throw new KettleException(
					"Unexpected error during classloader creation", e);
		}
	}
	...
	public static final String createFilename(String directory, String name,
			String extension) {
		if (directory.endsWith(Const.FILE_SEPARATOR)) {
			return directory + createFilename(name) + extension;
		} else {
			return directory + Const.FILE_SEPARATOR + createFilename(name)
					+ extension;
		}
	}
	...
	public static final String createName(String filename) {
		...
		if (pureFilename.endsWith(".ktr") || pureFilename.endsWith(".kjb")
	...
	/**
	 * Returning the internationalized tips of the days. They get created once
	 * on first request.
	 * 
	 * @return
	 */
	public static String[] getTips() {
		if (tips == null) {
			int tipsOfDayCount = toInt(BaseMessages.getString(PKG,
					"Const.TipOfDay.Count"), 0);
			tips = new String[tipsOfDayCount];
			for (int i = 1; i <= tipsOfDayCount; i++)
				tips[i - 1] = BaseMessages.getString(PKG, "Const.TipOfDay"
						+ Integer.toString(i));
		}
	...
	/**
	 * Returning the localized date conversion formats. They get created once on
	 * first request.
	 * 
	 * @return
	 */
	public static String[] getDateFormats() {
		if (dateFormats == null) {
			int dateFormatsCount = toInt(BaseMessages.getString(PKG,
					"Const.DateFormat.Count"), 0);
			dateFormats = new String[dateFormatsCount];
			for (int i = 1; i <= dateFormatsCount; i++)
				dateFormats[i - 1] = BaseMessages.getString(PKG,
						"Const.DateFormat" + Integer.toString(i));
		}
		return dateFormats;
	}

	/**
	 * Returning the localized number conversion formats. They get created once
	 * on first request.
	 * 
	 * @return
	 */
	public static String[] getNumberFormats() {
		if (numberFormats == null) {
			int numberFormatsCount = toInt(BaseMessages.getString(PKG,
					"Const.NumberFormat.Count"), 0);
			numberFormats = new String[numberFormatsCount + 1];
			numberFormats[0] = DEFAULT_NUMBER_FORMAT;
			for (int i = 1; i <= numberFormatsCount; i++)
				numberFormats[i] = BaseMessages.getString(PKG,
						"Const.NumberFormat" + Integer.toString(i));
		}
		return numberFormats;
	}

	/**
	 * @return An array of all default conversion formats, to be used in dialogs
	 *         etc.
	 */
		...
		if (STRING_TRANS_AND_JOB_FILTER_NAMES == null) {
			STRING_TRANS_AND_JOB_FILTER_NAMES = new String[] {
					BaseMessages.getString(PKG,
							"Const.FileFilter.TransformationJob"),
					BaseMessages.getString(PKG,
							"Const.FileFilter.Transformations"),
	...
	public static String safeAppendDirectory(String dir, String file) {
		boolean dirHasSeparator = ((dir.lastIndexOf(FILE_SEPARATOR)) == dir
				.length());
		boolean fileHasSeparator = (file.indexOf(FILE_SEPARATOR) != 0);
		if ((dirHasSeparator && !fileHasSeparator)
				|| (!dirHasSeparator && fileHasSeparator))
			return dir + file;
		if (dirHasSeparator && fileHasSeparator)
	...
	public static final int getPercentageFreeMemory() {
		...
		int percentage = (int) Math.round(100 * (double) totalFreeMemory
				/ (double) maxMemory);
	 ...
	 */
	public static Date addTimeToDate(Date input, String time, String DateFormat)
			throws Exception {
		if (isEmpty(time))
			return input;
		if (input == null)
	...
	public static String getKettlePropertiesFileHeader() {
		...
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line01", VERSION)
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line02")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line03")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line04")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line05")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line06")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line07")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line08")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line09")
				+ CR);
		out.append(BaseMessages.getString(PKG,
				"Props.Kettle.Properties.Sample.Line10")
				+ CR);
