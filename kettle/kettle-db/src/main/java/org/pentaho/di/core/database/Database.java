...
public class Database implements VariableSpace, LoggingObjectInterface
{
  ...
  public void cancelQuery() throws KettleDatabaseException {
	...
	public Result execStatement(String rawsql, Object[] data) throws KettleDatabaseException
	{
		if (data != null) {
			...
			execStatement(rawsql, params, data);
		}
 ...
 public Result execStatements(String script, RowMetaInterface params, Object[] data) throws KettleDatabaseException
 {
  ...
  public Object[] getLookup(PreparedStatement ps, boolean failOnMultipleResults) throws KettleDatabaseException {
	...
	public List<RowMetaAndData> getRowsWithMeta(String sql, int limit) throws KettleDatabaseException
	{
	...
	public List<RowMetaAndData> getRowsWithMeta(String sql, int limit, ProgressMonitorListener monitor) throws KettleDatabaseException
	{
		if (monitor!=null) monitor.setTaskName("Opening query...");
		ResultSet rset = openQuery(sql);
	...
	public List<RowMetaAndData> getRowsWithMeta(ResultSet rset, int limit, ProgressMonitorListener monitor) throws KettleDatabaseException
    {
        try
        {
