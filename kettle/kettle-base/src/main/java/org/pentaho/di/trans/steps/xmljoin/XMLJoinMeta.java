...
public class XMLJoinMeta extends BaseStepMeta implements StepMetaInterface {
	private static Class<?> PKG = XMLJoinMeta.class; // for i18n purposes,
														// needed by
														// Translator2!!
														// $NON-NLS-1$
	...
	public String getXML() {
		...
		retval
				.append("    ").append(XMLHandler.addTagValue("valueXMLField", valueXMLfield)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("targetXMLstep", targetXMLstep)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("targetXMLfield", targetXMLfield)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("sourceXMLstep", sourceXMLstep)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("sourceXMLfield", sourceXMLfield)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("complexJoin", complexJoin)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("joinCompareField", joinCompareField)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("targetXPath", targetXPath)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("encoding", encoding)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("omitXMLHeader", omitXMLHeader)); //$NON-NLS-1$ //$NON-NLS-2$
		retval
				.append("    ").append(XMLHandler.addTagValue("omitNullValues", omitNullValues)); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void readRep(Repository rep, ObjectId id_step,
		...
		try {
			targetXMLstep = rep
					.getStepAttributeString(id_step, "targetXMLstep"); //$NON-NLS-1$
			targetXMLfield = rep.getStepAttributeString(id_step,
					"targetXMLfield"); //$NON-NLS-1$
			sourceXMLstep = rep
					.getStepAttributeString(id_step, "sourceXMLstep"); //$NON-NLS-1$
			sourceXMLfield = rep.getStepAttributeString(id_step,
					"sourceXMLfield"); //$NON-NLS-1$
			...
			joinCompareField = rep.getStepAttributeString(id_step,
					"joinCompareField"); //$NON-NLS-1$
			valueXMLfield = rep
					.getStepAttributeString(id_step, "valueXMLfield"); //$NON-NLS-1$
			encoding = rep.getStepAttributeString(id_step, "encoding"); //$NON-NLS-1$
			omitXMLHeader = rep.getStepAttributeBoolean(id_step,
					"omitXMLHeader"); //$NON-NLS-1$
			omitNullValues = rep.getStepAttributeBoolean(id_step,
					"omitNullValues"); //$NON-NLS-1$
	...
	public void saveRep(Repository rep, ObjectId id_transformation,
		...
		try {
			rep.saveStepAttribute(id_transformation, id_step,
					"valueXMLfield", valueXMLfield); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"targetXMLstep", targetXMLstep); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"targetXMLfield", targetXMLfield); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"sourceXMLstep", sourceXMLstep); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"sourceXMLfield", sourceXMLfield); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"complexJoin", complexJoin); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"targetXPath", targetXPath); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"joinCompareField", joinCompareField); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"encoding", encoding); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"omitXMLHeader", omitXMLHeader); //$NON-NLS-1$
			rep.saveStepAttribute(id_transformation, id_step,
					"omitNullValues", omitNullValues); //$NON-NLS-1$
		} catch (Exception e) {
			throw new KettleException(
					"Unable to save step information to the repository for id_step=" + id_step, e); //$NON-NLS-1$
		}
	}
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta,
		...
		if (this.targetXMLstep == null || this.targetXMLstep.length() == 0) {
			cr = new CheckResult(
					...
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.TargetXMLStepNotSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.TargetXMLStepSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
		if (this.targetXMLfield == null || this.targetXMLfield.length() == 0) {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.TargetXMLFieldNotSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.TargetXMLFieldSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
		if (this.sourceXMLstep == null || this.sourceXMLstep.length() == 0) {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.SourceXMLStepNotSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.SourceXMLStepSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
		if (this.sourceXMLfield == null || this.sourceXMLfield.length() == 0) {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.SourceXMLFieldNotSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.SourceXMLFieldSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
		if (this.valueXMLfield == null || this.valueXMLfield.length() == 0) {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.ResultFieldNotSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.ResultFieldSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
		if (this.targetXPath == null || this.targetXPath.length() == 0) {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.TargetXPathNotSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		} else {
			cr = new CheckResult(
					CheckResultInterface.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.TargetXPathSpecified"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
				...
				if (this.targetXMLstep != null
					...
					cr = new CheckResult(
							...
							BaseMessages
									.getString(
											PKG,
											"XMLJoin.CheckResult.TargetXMLStepFound", this.targetXMLstep), stepMeta); //$NON-NLS-1$
					remarks.add(cr);
				}
				if (this.sourceXMLstep != null
					...
					cr = new CheckResult(
							...
							BaseMessages
									.getString(
											PKG,
											"XMLJoin.CheckResult.SourceXMLStepFound", this.sourceXMLstep), stepMeta); //$NON-NLS-1$
					remarks.add(cr);
				}
			}
			...
			if (!targetStepFound) {
				cr = new CheckResult(
						...
						BaseMessages
								.getString(
										PKG,
										"XMLJoin.CheckResult.TargetXMLStepNotFound", this.targetXMLstep), stepMeta); //$NON-NLS-1$
				remarks.add(cr);
			}
			if (!sourceStepFound) {
				cr = new CheckResult(
						...
						BaseMessages
								.getString(
										PKG,
										"XMLJoin.CheckResult.SourceXMLStepNotFound", this.sourceXMLstep), stepMeta); //$NON-NLS-1$
				remarks.add(cr);
			}
		} else {
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"XMLJoin.CheckResult.ExpectedInputError"), stepMeta); //$NON-NLS-1$
			remarks.add(cr);
		}
	}
