...
public class KettleDatabaseRepositoryBase {
	...
	public static final String FIELD_ROLE_DESCRIPTION = "DESCRIPTION";

	public static final String TABLE_R_USER_ROLE = "R_USER_ROLE";
	public static final String FIELD_USER_ROLE_RID = "RID";
	public static final String FIELD_USER_ROLE_UID = "UID";
	...
	public static final String repositoryTableNames[] = new String[] {
			...
			TABLE_R_JOBENTRY_COPY, TABLE_R_JOBENTRY_DATABASE,
			TABLE_R_JOBENTRY_TYPE, TABLE_R_JOB_HOP, TABLE_R_JOB_NOTE,
			TABLE_R_LOG, TABLE_R_LOGLEVEL, TABLE_R_NOTE, TABLE_R_PARTITION,
			TABLE_R_PARTITION_SCHEMA, TABLE_R_REPOSITORY_LOG, TABLE_R_SLAVE,
			TABLE_R_STEP, TABLE_R_STEP_ATTRIBUTE, TABLE_R_STEP_DATABASE,
			TABLE_R_STEP_TYPE, TABLE_R_TRANSFORMATION, TABLE_R_TRANS_ATTRIBUTE,
			TABLE_R_JOB_ATTRIBUTE, TABLE_R_TRANS_CLUSTER, TABLE_R_TRANS_HOP,
	...
	public String quoteTable(String table) {
		return repositoryMeta.getConnection().getQuotedSchemaTableCombination(
				null, table);
	}
