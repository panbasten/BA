...
public class ExecProcess extends BaseStep implements StepInterface {
    ...
    private void execProcess(String process, ProcessResult processresult) throws KettleException {
        ...
        try {
            ...
            if (p == null) {
                ...
                Thread outputThread = getOutputThreed(outputString, p.getInputStream());

                StringBuffer errorString = new StringBuffer();
                Thread errorThread = getOutputThreed(errorString, p.getErrorStream());
    ...
    private Thread getOutputThreed(final StringBuffer retvalBuff, final InputStream is) throws IOException {
