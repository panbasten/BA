...
public interface Repository {
	...
	/**
	 * @return the currently logged on user. (also available through the
	 *         repository security provider)
	 */
	...
	/**
	 * Connect to the repository. Make sure you don't connect more than once to
	 * the same repository with this repository object.
	 * 
	 * @param username
	 ...
	 *             already connected to the repository.
	 */
	...
	/**
	 * Save an object to the repository optionally overwriting any associated
	 * objects.
	 * 
	 ...
	 * @param overwrite
	 *            Overwrite any existing objects involved in saving {@code
	 *            repositoryElement}, e.g. repositoryElement, database
	 *            connections, slave servers
	 * @throws KettleException
	 ...
	 *            set to true if you want to automatically set the internal
	 *            variables of the loaded transformation. (true is the default
	 ...
	 */
	public TransMeta loadTransformation(ObjectId id_transformation,
	 ...
	 * @param newDirectory
	 *            The RepositoryDirectoryInterface that will be the new parent
	 *            of the transformation (May be null if a move is not desired)
	 * @param newName
	 *            The new name of the transformation (May be null if a rename is
	 *            not desired)
	...
	/**
	 * Delete everything related to a transformation from the repository. This
	 * does not included shared objects : databases, slave servers, cluster and
	 * partition schema.
	 * 
	 * @param id_transformation
	...
	public JobMeta loadJob(String jobname, RepositoryDirectoryInterface repdir,
			ProgressMonitorListener monitor, String revision)
			throws KettleException;
	 ...
	 *            version to load. Specify null to load the last version.
	 */
	public JobMeta loadJob(ObjectId id_job, String versionLabel)
			throws KettleException;
	 ...
	 * @param newDirectory
	 *            The RepositoryDirectoryInterface that will be the new parent
	 *            of the job (May be null if a move is not desired)
	 * @param newName
	 *            The new name of the job (May be null if a rename is not
	 *            desired)
	 ...
	 */
	public DatabaseMeta loadDatabaseMeta(ObjectId id_database, String revision)
			throws KettleException;
	...
	// public ObjectId[] getPartitionIDs(ObjectId id_partition_schema) throws
	// KettleException;
	 ...
	 * @param newParentDir
	 *            The RepositoryDirectoryInterface that will be the new parent
	 *            of the repository directory (May be null if a move is not
	 *            desired)
	 * @param newName
	 *            The new name of the repository directory (May be null if a
	 *            rename is not desired)
	 ...
	 * {@link #getJobObjects(ObjectId, boolean)} and
	 * {@link #getTransformationObjects(ObjectId, boolean)} into one operation.
	 * 
	 * @param id_directory
	 *            directory
	...
	public String[] getJobNames(ObjectId id_directory, boolean includeDeleted)
			throws KettleException;
	...
	/**
	 * Insert an entry in the audit trail of the repository. This is an optional
	 * operation and depends on the capabilities of the underlying repository.
	 * 
	 * @param The
	...
	public void insertJobEntryDatabase(ObjectId id_job, ObjectId id_jobentry,
	...
	public int countNrStepAttributes(ObjectId id_step, String code)
			throws KettleException;
	...
	public int countNrJobEntryAttributes(ObjectId id_jobentry, String code)
			throws KettleException;
	...
	/**
	 * This method is introduced to avoid having to go over an
	 * integer/string/whatever in the interface and the step code.
	 * 
	 * @param id_step
	 * @param code
	 * @return
	...
	/**
	 * This method is introduced to avoid having to go over an
	 * integer/string/whatever in the interface and the job entry code.
	 * 
	 * @param id_step
	 * @param code
	 * @return
	...
	/**
	 * Removes he deleted flag from a repository element in the repository. If
	 * it wasn't deleted, it remains untouched.
	 * 
	 * @param element
	...
	/**
	 * Get more information about a certain object ID in the form of the
	 * RepositoryObject
	 * 
	 * @param objectId
	...
	/**
	 * This is an informational message that a repository can display on
	 * connecting within Spoon. If a null is returned, no message is displayed
	 * to the end user.
	 * 
	 * @return message
	 */
