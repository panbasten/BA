...
public class SalesforceDeleteMeta extends BaseStepMeta implements
		StepMetaInterface {
	private static Class<?> PKG = SalesforceDeleteMeta.class; // for i18n
																// purposes,
																// needed by
																// Translator2!!
																// $NON-NLS-1$
	...
	public String getXML() {
		...
		retval.append("    "
				+ XMLHandler.addTagValue("DeleteField", DeleteField));
	...
	public void readRep(Repository rep, ObjectId id_step,
		...
		try {
			...
			throw new KettleException(BaseMessages.getString(PKG,
					"SalesforceDeleteMeta.Exception.ErrorReadingRepository"), e);
		}
	}
	...
	public void saveRep(Repository rep, ObjectId id_transformation,
		...
		try {
			...
			rep.saveStepAttribute(id_transformation, id_step, "DeleteField",
					DeleteField);
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta,
		...
		if (input.length > 0)
			cr = new CheckResult(
					...
					BaseMessages.getString(PKG,
							"SalesforceDeleteMeta.CheckResult.NoInputExpected"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"SalesforceDeleteMeta.CheckResult.NoInput"),
					stepMeta);
		remarks.add(cr);
		...
		if (Const.isEmpty(targeturl))
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages
					.getString(PKG, "SalesforceDeleteMeta.CheckResult.NoURL"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages
					.getString(PKG, "SalesforceDeleteMeta.CheckResult.URLOk"),
					stepMeta);
		remarks.add(cr);
		...
		if (Const.isEmpty(username))
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages
					.getString(PKG,
							"SalesforceDeleteMeta.CheckResult.NoUsername"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages
					.getString(PKG,
							"SalesforceDeleteMeta.CheckResult.UsernameOk"),
					stepMeta);
		remarks.add(cr);
		...
		if (Const.isEmpty(module))
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"SalesforceDeleteMeta.CheckResult.NoModule"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"SalesforceDeleteMeta.CheckResult.ModuleOk"),
					stepMeta);
		remarks.add(cr);
	...
	public StepInterface getStep(StepMeta stepMeta,
			...
			Trans trans) {
		return new SalesforceDelete(stepMeta, stepDataInterface, cnr,
				transMeta, trans);
	}
