...
public class SalesforceInsertMeta extends BaseStepMeta implements
		StepMetaInterface {
	private static Class<?> PKG = SalesforceInsertMeta.class; // for i18n
																// purposes,
																// needed by
																// Translator2!!
																// $NON-NLS-1$
	...
	public void readRep(Repository rep, ObjectId id_step,
		...
		try {
			...
			throw new KettleException(BaseMessages.getString(PKG,
					"SalesforceInsertMeta.Exception.ErrorReadingRepository"), e);
		}
	}
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta,
		...
		if (input.length > 0)
			cr = new CheckResult(
					...
					BaseMessages.getString(PKG,
							"SalesforceInsertMeta.CheckResult.NoInputExpected"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"SalesforceInsertMeta.CheckResult.NoInput"),
					stepMeta);
		remarks.add(cr);
		...
		if (Const.isEmpty(targeturl))
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages
					.getString(PKG, "SalesforceInsertMeta.CheckResult.NoURL"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages
					.getString(PKG, "SalesforceInsertMeta.CheckResult.URLOk"),
					stepMeta);
		remarks.add(cr);
		...
		if (Const.isEmpty(username))
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR, BaseMessages
					.getString(PKG,
							"SalesforceInsertMeta.CheckResult.NoUsername"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK, BaseMessages
					.getString(PKG,
							"SalesforceInsertMeta.CheckResult.UsernameOk"),
					stepMeta);
		remarks.add(cr);
		...
		if (Const.isEmpty(module))
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"SalesforceInsertMeta.CheckResult.NoModule"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"SalesforceInsertMeta.CheckResult.ModuleOk"),
					stepMeta);
		remarks.add(cr);
		...
		if (updateLookup.length == 0)
			cr = new CheckResult(CheckResult.TYPE_RESULT_ERROR,
					BaseMessages.getString(PKG,
							"SalesforceInsertMeta.CheckResult.NoFields"),
					stepMeta);
		else
			cr = new CheckResult(CheckResult.TYPE_RESULT_OK,
					BaseMessages.getString(PKG,
							"SalesforceInsertMeta.CheckResult.FieldsOk"),
					stepMeta);
		remarks.add(cr);
	...
	public StepInterface getStep(StepMeta stepMeta,
			...
			Trans trans) {
		return new SalesforceInsert(stepMeta, stepDataInterface, cnr,
				transMeta, trans);
	}
