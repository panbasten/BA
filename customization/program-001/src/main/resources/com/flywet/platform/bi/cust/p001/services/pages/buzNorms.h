<form method="post" id="portal_menu_form">
	...
	<fly:gridLayout column="1" itemWidth="98%" itemMargin="10" class="fly_portal_menu_content">
		<fly:gridLayoutItem>
			<fly:pushbutton style="float:left;" iconCls="ui-icon-plusthick" onclick="Flywet.PortalAction.openUploadDialog(null,{'filesNum':5,'rootDir':'custom.portal.buzNorm.file.rootPath','workDir':'','category':'custom.portal.buzNorm.file.category'},'buzNormsUpdate()')" label="添加" title="添加" />
