package com.flywet.platform.bi.component.resolvers.container;
...
import com.flywet.platform.bi.component.components.tab.FLYTabViewMeta;
import com.flywet.platform.bi.component.components.tab.TabNode;
...
public class FLYTabViewResolver extends BaseComponentResolver implements
	...
	public void renderScript(FLYTabViewMeta tabView, List<String> script) {
		...
		// 添加TabView脚本
		script.add("Flywet.cw(\"EasyTabs\",\"" + tabView.getId()
