...
import com.flywet.platform.bi.el.parser.ParseException;
import com.flywet.platform.bi.el.parser.Token;
import com.flywet.platform.bi.el.parser.TokenMgrError;
...
public class ExpressionEvaluatorImpl extends ExpressionEvaluator {
	...
	/**
	 * The mapping from ExpectedType to Maps mapping literal String to parsed
	 * value
	 **/
	...
	/**
	 * 
	 * Creates or returns the Map that maps string literals to parsed values for
	...
	/**
	 * 
	 * Formats a ParseException into an error message suitable for displaying on
	 * a web page
	 **/
	...
	/**
	 * 
	 * Parses the given expression string, then converts it back to a String in
	 * its canonical form. This is used to test parsing.
	 **/
	...
	/**
	 * An object that encapsulates an expression to be evaluated by the JSTL
	 * evaluator.
	 */
	private class JSTLExpression extends javax.servlet.jsp.el.Expression {
		...
		public JSTLExpression(final ExpressionEvaluatorImpl evaluator,
				final Expression expression, final Class expectedType,
				final FunctionMapper fMapper) throws ELException {
		...
		public JSTLExpression(final ExpressionEvaluatorImpl evaluator,
				final String expressionString, final Class expectedType,
				final FunctionMapper fMapper) throws ELException {
			this.evaluator = evaluator;
		...
		public Object evaluate(VariableResolver vResolver) throws ELException {
			return evaluator.evaluateParsedValue(this.parsedExpression,
					this.expectedType, vResolver, null);
		}
	}
