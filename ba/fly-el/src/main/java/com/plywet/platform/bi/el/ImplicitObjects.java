 ...
 * 
 * <p>
 * This class is used to generate the implicit Map and List objects that wrap
 * various elements of the PageContext. It also returns the correct implicit
 * object for a given implicit object name.
 * 
 *@author PeterPan
 *
 **/
...
public class ImplicitObjects {
	...
	static final String sAttributeName = "org.apache.commons.el.ImplicitObjects";
	...
	/**
	 * 
	 * Finds the ImplicitObjects associated with the PageContext, creating it if
	...
	/**
	 * 
	 * Returns the Map that maps init parameter name to a single init parameter
	 * values.
	 **/
	...
	/**
	 * 
	 * Returns the Map that maps cookie name to the first matching Cookie in
	 * request.getCookies().
	 **/
	...
	/**
	 * 
	 * Creates the Map that maps init parameter name to single init parameter
	 * value.
	 **/
	...
	/**
	 * 
	 * Creates the Map that maps cookie name to the first matching Cookie in
	 * request.getCookies().
	 **/
