package com.flywet.platform.bi.component.ss.utils;

import java.util.Map;
import java.util.concurrent.ConcurrentHashMap;

import com.flywet.platform.bi.component.ss.model.CellPosition;
import com.flywet.platform.bi.component.ss.model.NanedRange;
...
public class SpreadSheetUtils {
	 ...
	 * @return
	 */
	public static boolean cross(NanedRange ca1, NanedRange ca2) {
