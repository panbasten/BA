...
import com.flywet.platform.bi.core.utils.CloneUtils;

public class Cell implements ComponentObjectInterface {
	...
	public Cell clone() {
		try {
			...
			newcell.val = CloneUtils.deepCopy(val);
			newcell.extFmtMap = CloneUtils.deepCopy(extFmtMap);
			return newcell;
		} catch (Exception e) {
