 ...
 * 
 */
public class BILicenseException extends Exception {

	private static final long serialVersionUID = -6961797389373707628L;
	 ...
	 */
	public BILicenseException(String message) {
		super(message);
	 ...
	 */
	public BILicenseException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            原因（被保存用来供以后的getCause()方法调用）。（允许空值，表明该原因不存在或者未知）
	 */
	public BILicenseException(String message, Throwable cause) {
		super(message, cause);
	}
